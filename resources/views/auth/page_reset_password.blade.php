				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						...
						<form>
							...
							<p class="text-center mt-lg">Remembered? <a href={{ url('/signin') }}>Sign In!</a>
						</form>
					</div>
				</div>

				<p class="text-center text-muted mt-md mb-md">&copy; Copyright 2014. All rights reserved.</a>.</p>
			</div>
		</section>
		<!-- end: page -->
