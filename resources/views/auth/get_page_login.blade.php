			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						...
						<form action={{ url('post-sign-in') }} method="post">
                            @csrf
							...
							<div class="form-group mb-lg">
								<div class="clearfix">
									...
									<a href={{ url('/forget-password') }} class="pull-right">Forget Password?</a>
								</div>
								<div class="input-group input-group-icon">
									<input name="password" type="password" class="form-control input-lg" value="{{old('password')}}" />
									<span class="input-group-addon">
										<span class="icon icon-lg">
