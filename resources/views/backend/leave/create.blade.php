        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="col-md-11">
                    ...
                    <form id="" action="{{route('backend.save-leave')}}" method="POST" class="form-horizontal form-bordered">
                        @csrf
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Leave Type Name:</label>
                            <div class="col-sm-8">
                                <select name="leave_types_id" id="leave_types_id" class="form-control">
