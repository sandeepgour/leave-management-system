        ...
        <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
                ...
                <div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
                    <span class="name">{{Auth::user() ? Auth::user()->name : ''}}</span>
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled">
                    <li class="divider"></li>
                    <li>
                        <a role="menuitem" tabindex="-1" href="{{route('backend.my.profile')}}"><i class="fa fa-user"></i> My Profile</a>
                    </li>
                    {{-- <li>
                    ...
                    <li>
                        <a role="menuitem" tabindex="-1"
                         href="{{ route('user.logout')}}"><i class="fa fa-power-off"></i> Logout</a>
                    </li>
                </ul>
            </div>
        </div>
